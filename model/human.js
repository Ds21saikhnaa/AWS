...
const HumanSchema = new Schema({
    name: {
        type: String,
        required: [true, "Ta neree zaawal oruulna uu!"]
    },email: {
        type: String,
...
// HumanSchema.pre("remove",async function (next){
//     await this.model("Post").deleteMany({createUser: this._id})
//     next();
// });

HumanSchema.methods.getJsonWebToken = function(){
...
HumanSchema.methods.checkPassword = async function(enteredPassword){
